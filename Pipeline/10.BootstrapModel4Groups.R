...
xb$AGE[which(xb$from %in% c(2,3,7,8, 12,13, 17, 18) &
                 xb$to %in% c(5, 10, 15, 20))] <-
                     xb$AGE[which(xb$from %in% c(2,3,7,8,12,13,17,18) &
                                      xb$to %in% c(5, 10,15,20))] +
        xb$Tstart[which(xb$from %in% c(2,3,7,8,12,13,17,18) &
                            xb$to %in% c(5, 10,15,20))]
...
Oldnewdata.DR$AGE.DR[which(Oldnewdata.DR$strata %in% seq(from=9,by=9, length=4))] <-
    Oldnewdata.DR$AGE.DR[which(Oldnewdata.DR$strata %in% seq(from=9,by=9, length=4))] +
...
Oldnewdata.LR$AGE.LR[which(Oldnewdata.LR$strata %in% seq(from=7, by=9, length=4))] <-
Oldnewdata.LR$AGE.LR[which(Oldnewdata.LR$strata %in% seq(from=7, by=9, length=4))] +
    Oldnewdata.LR$TLastSurgery[which(Oldnewdata.LR$strata %in%
                                   seq(from=6, by=9, length=4))]
Oldnewdata.LR$AGE.DR[which(Oldnewdata.LR$strata %in% seq(from=9,by=9, length=4))] <-
Oldnewdata.LR$AGE.LR[which(Oldnewdata.LR$strata %in% seq(from=7, by=9, length=4))]
